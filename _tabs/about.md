...
| 기간 | 회사명 | 직무 | 업무 내용 |
|-----|------|-----|---------|
| 2022.10 ~  | Cocone Engineering Korea | Software Engineer | 주업무 :: 다양한 서비스의 서버/CMS 개발 및 유지보수<br>글로벌 론칭 및 이벤트 운영을 지원하며, 라이브 서비스 운영 및 긴급 이슈 대응<br>CMS 개발 및 기능 개선, 데이터 등록 프로세스 개선 |
...
| 활동명                          | 기간                      | 주최 | 비고                                                                 |
|-------------------------------|------------------------|-----|-----------------------------------------------------------------|
| 오픈소스 컨트리뷰션 아카데미 | 2025.07 ~ 2025.10 | Open UP 운영사무국  | Yorkie 오픈소스 기여  |
